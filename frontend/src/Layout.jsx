...
export default function Layout() {
  ...
  const hideHeaderRoutes = ["/"].includes(location.pathname);
  ...
  return (
    <div className="min-h-screen bg-app-gradient text-slate-900">
      ...
      <main className={hideHeaderRoutes ? "mx-auto w-full max-w-none px-0 py-0" : "mx-auto w-full max-w-7xl px-4 py-8"}>
        <Outlet />
      </main>
    </div>
  );
